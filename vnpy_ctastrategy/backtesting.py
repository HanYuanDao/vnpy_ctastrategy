...
class BacktestingEngine:
    ...
    def set_parameters(
        ...
        self.rate_money = rate_money
        self.rate_volume = rate_volume
    ...
    def load_data(self):
        ...
        if self.mode != BacktestingMode.TICK and self.start >= self.end:
    ...
    def run_backtesting(self):
        ...
        if self.mode != BacktestingMode.TICK and len(backtesting_data) <= 1:
    ...
    def calculate_statistics(self, df: DataFrame = None, output=True):
        ...
        if output:
            ...
            self.output(f"交易回合胜率：\t{success_rate:,.2f}%")
    ...
    def cross_limit_order(self):
        ...
        if self.mode == BacktestingMode.BAR:
            ...
            long_cross_price = self.tick.bid_price_1
            short_cross_price = self.tick.ask_price_1
    ...
    def send_order(
        ...
        if stop:
            vt_orderid = self.send_stop_order(direction, offset, price, volume, memo)
        else:
...
class DailyResult:
    ...
    def calculate_pnl(
        ...
        for trade in self.trades:
            ...
            self.commission += turnover * rate_money + trade.volume * rate_volume
